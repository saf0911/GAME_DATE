...
exports.default = function () {
  var _ref = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee(dir, options) {
    var outDir, nextDir, config, buildId, buildStats, exportPathMap, exportPaths, renderOpts, _iteratorNormalCompletion, _didIteratorError, _iteratorError, _iterator, _step, path, _exportPathMap$path, page, _exportPathMap$path$q, query, req, res, htmlFilename, baseDir, htmlFilepath, html, log;
        ...
        switch (_context.prev = _context.next) {
          ...
          case 29:
            if (typeof config.exportPathMap !== 'function') {
              (0, _utils.printAndExit)('> Could not found "exportPathMap" function inside "next.config.js"\n' + '> "next export" uses that function build html pages.');
            }
